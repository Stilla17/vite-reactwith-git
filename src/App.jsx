  ...
  return (
    <>
      <header>
        ...
        <div className='w-[100%] h-[100vh] flex justify-center items-center border-amber-500'>

          <div className='w-[1538px] flex justify-between items-center'>
            {/* text */}
          ...
          <div className=' w-[740px]'>
            ...
            <div className='w-[662px] h-[653px] bg-[#53EC62] rounded-full mx-auto z-1'> {/* <img src="" alt="" /> */}</div>
